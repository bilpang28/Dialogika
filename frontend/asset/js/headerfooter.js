...
class Header extends HTMLElement {
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="../dashboard/" target="_blank" class="appointment-btn">Login<span class="d-none d-md-inline"></span></a>
    </div>
  </header><!-- End Header -->
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="">
              <div class="footer-recent-post align-items-center">
                ...
                <ul>
                  <li class="clearfix">
                    <img src="asset/img/intern/footer1.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                  ...
                  <hr/>
                  <li class="clearfix">
                    <img src="asset/img/intern/footer2.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                    <div class="post float-left">
                  ...
                  <hr/>
                  <li class="clearfix">
                    <img src="asset/img/intern/footer3.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                    <div class="post float-left">
                  ...
                  <hr/>
                  <li class="clearfix">
                    <img src="asset/img/intern/footer4.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                    <div class="post float-left">
