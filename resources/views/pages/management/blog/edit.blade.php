...
@section('content')
    ...
    <div class="container mt-10">
        ...
        <form action="{{ route('management.blog.update', ['id' => $article->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mb-5">
                ...
                <input type="text" class="form-control" id="title" name="title" maxlength="30" required value="{{$article->title}}">
            </div>
