                    ...
                    <div class="scroll-y me-n10 pe-10" id="modal_import_emp_scroll" data-kt-scroll="true"
                        ...
                        <div class="row mb-9">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control form-control-solid" required name="name" id="edit_name">
                            </div>
                            <div class="col-12 mb-3">
                                <label class="d-flex align-items-center fs-6 form-label mb-2">
                                    <span class="required fw-bold">Email</span>
                                </label>
                                <input type="email" class="form-control form-control-solid" required name="email" id="edit_email">
                            </div>
                            <div class="col-12 mb-3">
                                <label class="d-flex align-items-center fs-6 form-label mb-2">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="date" class="form-control form-control-solid" name="birth_date" id="edit_birth_date">
                            </div>
                            <div class="col-12 mb-3">
                                <label class="d-flex align-items-center fs-6 form-label mb-2">
