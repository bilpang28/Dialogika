        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    <h3><img src="{{asset('guest')}}/img/white-logo.webp" class="footer-logo" alt="Kelas Public Speaking Jogja" /></h3>
                    <p>
                        Wadah pengembangan diri membangun aura positif sekaligus meningkatkan kualitas skill, karir
                        hingga level
                        kehidupan Anda.
                    </p><br>
                    ...
                    <div class="social-link d-flex mt-3">
                        <a href="https://link.dialogika.co/wasap-2597-dialogika-co"
                            class="text-light d-flex align-items-center justify-content-center"><i
                    ...
                    <br><br>
                    <h4 class="d-flex justify-content-between">Follow Us<i class='bx bx-chevron-down d-md-none'></i>
                    </h4>
                    <div class="social-link d-flex mt-3">
                        <a href="https://link.dialogika.co/twitter"
                            class="d-flex align-items-center justify-content-center"><i class="bi bi-twitter"></i></a>
                        <a href="https://link.dialogika.co/facebook"
                            class="d-flex align-items-center justify-content-center"><i class="bi bi-facebook"></i></a>
                        <a href="https://link.dialogika.co/instagram"
                            class="d-flex align-items-center justify-content-center"><i class="bi bi-instagram"></i></a>
                        <a href="https://link.dialogika.co/linkedin"
                ...
                <div class="col-lg-2 col-md-6 footer-links accordion">
                    ...
                    <div class="">
                        ...
                        <ul class="accordion-collapse collapse show" id="footer-best-program"
                    ...
                    <div class="">
                        <a href="#footer-corporate-program" class="d-flex justify-content-between"
                            data-bs-toggle="collapse" id="footer-accordion">
                        ...
                        <ul class="accordion-collapse collapse show" id="footer-corporate-program">
                            ...
                            <li><i class="bx bx-chevron-right"></i>
                                <a href="../program/first-class.html">Surabaya <span
                                        class="badge rounded-pill text-bg-warning">Coming Soon</span></a>
                            </li>
                        </ul>
                    </div><br>

                    <div class="">
                        <a href="#footer-private-program" class="d-flex justify-content-between"
                            data-bs-toggle="collapse" id="footer-accordion">
                            <h4>Kids Program</h4><i class='bx bx-chevron-down d-md-none'></i>
                        </a>
                        <ul class="accordion-collapse collapse show" id="footer-private-program"
                            data-bs-parent=".footer-links">
                            <li><i class="bx bx-chevron-right"></i>
                    ...
                    <div class="">
                        ...
                        <ul class="accordion-collapse collapse show" id="footer-career-info"
                            data-bs-parent=".footer-links">
                            <li><i class="bx bx-chevron-right"></i>
                    ...
                    <div class="">
                        ...
                        <ul class="accordion-collapse collapse show" id="footer-useful-link"
                            data-bs-parent=".footer-links">
                            <li><i class="bx bx-chevron-right"></i>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <div class="">
                        <a href="#footer-about-dialogika" class="d-flex justify-content-between"
                            data-bs-toggle="collapse" id="footer-accordion">
                            <h4>About Dialogika</h4><i class='bx bx-chevron-down d-md-none'></i>
                        </a>
                        <ul class="accordion-collapse collapse show" id="footer-about-dialogika"
                            data-bs-parent=".footer-links">
                            <li><i class="bx bx-chevron-right"></i>
                    ...
                    <div class="">
                        <div class="footer-recent-post align-items-center">
                            ...
                            <ul>
                                <li class="clearfix">
                                    <img src="{{asset('guest')}}/img/intern/footer1.jpg" alt=""
                                        class="rounded ig-post float-left"
                                        style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                                    <div class="post float-left">
                                        <a target="__blank" href="https://www.instagram.com/p/Claa6CPISTB/">Gambaran
                                            kelas praktek public speaking secara offline</a>
                                        <div class="date"><i class="bx bx-calendar" aria-hidden="true"></i> Nov 26,
                                            2022</div>
                                    </div>
                                </li>
                                <hr />
                                <li class="clearfix">
                                    <img src="{{asset('guest')}}/img/intern/footer2.jpg" alt=""
                                        class="rounded ig-post float-left"
                                        style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                                    <div class="post float-left">
                                        <a target="__blank" href="https://www.instagram.com/p/CyXfjtkrJe7/">Tips-tips
                                            agar di notice dosen didalam kelas dan latihan membangun persona.</a>
                                        <div class="date"><i class="bx bx-calendar" aria-hidden="true"></i> Oct 14,
                                            2023</div>
                                    </div>
                                </li>
                                <hr />
                                <li class="clearfix">
                                    <img src="{{asset('guest')}}/img/intern/footer3.jpg" alt=""
                                        class="rounded ig-post float-left"
                                        style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                                    <div class="post float-left">
                                        <a target="__blank" href="https://www.instagram.com/p/CzAf73qr2mj/">5 tips
                                            jitu atasi otak yang ngeblank saat berbicara di depan umum</a>
                                        <div class="date"><i class="bx bx-calendar" aria-hidden="true"></i> Oct 30,
                                            2023</div>
                                    </div>
                                </li>
                                <hr />
                                <li class="clearfix">
                                    <img src="{{asset('guest')}}/img/intern/footer4.jpg" alt=""
                                        class="rounded ig-post float-left"
                                        style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                                    <div class="post float-left">
                                        <a target="__blank" href="blog-details.html">5 trik untuk para newbie agar
                                            viral di depan umum. (Cocok untuk konten creator)</a>
                                        <div class="date"><i class="bx bx-calendar" aria-hidden="true"></i> Nov 2,
                                            2023</div>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 footer-newsletter">
                    ...
                    <form action="javascript:void" role="form" id="subcriptions" method="post">
                        <input type="tel" name="Surel" placeholder="Nomor Whatsapp"><input type="submit"
                            value="Connect Now" onclick="Subcription()">
                    </form>
                    <br><br>
                    <h4 class="d-flex justify-content-between">Payment Method<i
                            class='bx bx-chevron-down d-md-none'></i></h4>
                    <p><i class="bx bx-chevron-down"></i> Bank Transfer</p>
                    <img src="{{asset('guest')}}/img/bank.webp" style="width:100%;" />
                    <br><br>
                    <p><i class="bx bx-chevron-down"></i> E-Wallet</p>
                    <img src="{{asset('guest')}}/img/wallet.webp" style="width:100%;" />

                    <ul class="list-group border-warning" style="background: transparent;">
                        <li class="list-group-item">
                            <b>Telah Terdaftar Oleh</b><br>
                            <img src="{{asset('guest')}}/img/ham.webp" class="" /><br>
